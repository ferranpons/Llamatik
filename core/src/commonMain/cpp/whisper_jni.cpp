...
Java_com_llamatik_core_platform_WhisperBridge_initModel(JNIEnv* env, jobject, jstring path) {
...
Java_com_llamatik_core_platform_WhisperBridge_transcribeWav(JNIEnv* env, jobject, jstring wavPath, jstring lang, jstring initialPrompt) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_llamatik_core_platform_WhisperBridge_transcribeWavSegments(JNIEnv* env, jobject, jstring wavPath, jstring lang, jstring initialPrompt, jboolean translate, jboolean diarize) {
    const char* cwav = env->GetStringUTFChars(wavPath, nullptr);
    const char* clang = lang ? env->GetStringUTFChars(lang, nullptr) : nullptr;
    const char* cprompt = initialPrompt ? env->GetStringUTFChars(initialPrompt, nullptr) : nullptr;
...
Java_com_llamatik_core_platform_WhisperBridge_release(JNIEnv*, jobject) {
whisper_stt_release();
}
