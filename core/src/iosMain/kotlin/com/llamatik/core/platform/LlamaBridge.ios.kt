...
import com.llamatik.core.platform.llama.llama_apply_chat_template
import com.llamatik.core.platform.llama.llama_embed
import com.llamatik.core.platform.llama.llama_embed_free
import com.llamatik.core.platform.llama.llama_embed_init
import com.llamatik.core.platform.llama.llama_embedding_size
import com.llamatik.core.platform.llama.llama_free_embedding
import com.llamatik.core.platform.llama.llama_generate
import com.llamatik.core.platform.llama.llama_generate_cancel
import com.llamatik.core.platform.llama.llama_generate_chat
import com.llamatik.core.platform.llama.llama_generate_chat_json_schema
import com.llamatik.core.platform.llama.llama_generate_chat_json_schema_stream
import com.llamatik.core.platform.llama.llama_generate_chat_stream
import com.llamatik.core.platform.llama.llama_generate_continue
import com.llamatik.core.platform.llama.llama_generate_continue_stream
import com.llamatik.core.platform.llama.llama_generate_free
import com.llamatik.core.platform.llama.llama_generate_init
import com.llamatik.core.platform.llama.llama_generate_json_schema
import com.llamatik.core.platform.llama.llama_generate_json_schema_stream
import com.llamatik.core.platform.llama.llama_generate_session_load
import com.llamatik.core.platform.llama.llama_generate_session_reset
import com.llamatik.core.platform.llama.llama_generate_session_save
import com.llamatik.core.platform.llama.llama_generate_set_params
import com.llamatik.core.platform.llama.llama_generate_stream
import com.llamatik.core.platform.llama.llama_get_model_chat_template
import com.llamatik.core.platform.llama.llama_get_model_finetune_type
import com.llamatik.core.platform.llama.llama_mtp_init
import com.llamatik.core.platform.llama.llama_mtp_shutdown
import com.llamatik.core.platform.llama.llama_session_create
...
actual object LlamaBridge {
    ...
    actual fun generateContinueStream(prompt: String, callback: GenStream) {
        memScoped {
            ...
            try {
                llama_generate_continue_stream(prompt, onDelta, onDone, onError, ref.asCPointer())
            } finally {
                ref.dispose()
            }
        }
