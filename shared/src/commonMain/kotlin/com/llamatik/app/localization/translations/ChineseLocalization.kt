...
internal object ChineseLocalization : Localization {
    ...
    override val onboardingPromoTitle1 = "免责声明"
    override val onboardingPromoTitle2 = "手册和指南"
    override val onboardingPromoTitle3 = "内置小游戏"
    override val onboardingPromoTitle4 = "您是Eagle Dynamics的员工吗？"

    override val onboardingPromoLine1 =
        "正如您可能注意到的，这个应用程序不是官方的。这是一个由粉丝开发的应用程序。这意味着“数字战斗模拟（DCS）和Eagle Dynamics”的徽标和图像归Fighter Collection Ltd和Eagle Dynamics SA所有。该应用程序及其开发者与Eagle Dynamics没有关系，也未得到其认可。它仅引用了公开资源，网址为 "
    override val onboardingPromoLine2 =
        "此应用程序包括快速访问您最喜欢的模块手册和指南的快捷方式。我们还在开发新功能，以帮助您进行DCS飞行。"
    override val onboardingPromoLine3 =
        "我们热爱电子游戏，尤其是与飞机和直升机相关的游戏。因此，我们为您添加了一个小型的1942游戏克隆版。"
    override val onboardingPromoLine4 =
        "我们愿意与ED合作，为DCS玩家提供一个新维度，让他们更加融入并连接到DCS生态系统。\n这个应用程序及其功能只是可以实现的冰山一角。\n如果您对此感兴趣，请发送电子邮件至 "
