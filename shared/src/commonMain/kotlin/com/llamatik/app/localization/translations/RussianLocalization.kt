...
"""
    override val gemma3SystemPrompt = "Вы — полезный ассистент. Отвечайте пользователю прямо и лаконично."
    override val smolVLM256SystemPrompt = """
Вы — локальный ассистент, использующий небольшую модель «зрение-язык» (SmolVLM 256M Instruct).
...
Вы — локальный ассистент, использующий SmolVLM 500M Instruct, модель «зрение-язык» среднего размера.
...
Вы — многоязычный локальный ассистент, использующий Qwen 2.5 Instruct.
...
Вы — локальный ассистент, использующий Phi-1.5, небольшой и эффективный модель для кода и рассуждений.
...
Вы — локальный ассистент, использующий Llama 3.2 1B Instruct, мощную компактную модель общего назначения.
