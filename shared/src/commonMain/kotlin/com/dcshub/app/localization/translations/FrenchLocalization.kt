...
internal object FrenchLocalization : Localization {
    ...
    override val onboardingPromoTitle1 = "Avertissement"
    override val onboardingPromoTitle2 = "Manuels et Guides"
    override val onboardingPromoTitle3 = "Jeu vidéo intégré"
    override val onboardingPromoTitle4 = "Êtes-vous un employé d'Eagle Dynamics ?"

    override val onboardingPromoLine1 =
        "Comme vous l'avez peut-être remarqué, cette application n'est pas officielle. Il s'agit d'une application créée par des fans. Cela signifie que les logos et images de 'Digital Combat Simulator (DCS) et Eagle Dynamics' appartiennent à Fighter Collection Ltd et Eagle Dynamics SA. Cette application et son développeur ne sont pas affiliés ni approuvés par Eagle Dynamics. Elle ne contient que des références à des ressources publiques disponibles sur "
    override val onboardingPromoLine2 =
        "Cette application comprend des raccourcis pour accéder à vos manuels et guides de module préférés. Nous développons également de nouvelles fonctionnalités qui vous aideront dans vos vols DCS."
    override val onboardingPromoLine3 =
        "Nous adorons les jeux vidéo, en particulier ceux liés aux avions et aux hélicoptères. Nous avons donc inclus un petit clone du jeu 1942 pour que vous puissiez en profiter."
    override val onboardingPromoLine4 =
        "Nous sommes prêts à collaborer avec ED pour offrir aux joueurs de DCS une nouvelle dimension, leur permettant d’être plus engagés et connectés à l’écosystème de DCS. \nCette application et ses fonctionnalités ne sont que la partie émergée de l’iceberg de ce qui peut être réalisé.\nSi cela vous intrigue, veuillez envoyer un e-mail à "
