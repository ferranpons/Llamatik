...
import com.dcshub.app.platform.DCSHubTempFile
...
class DownloadFileRepository(private val service: ServiceClient) {
    ...
    suspend fun downloadFileAndSave(url: String, fileName: String): DCSHubTempFile {
        val file = DCSHubTempFile(fileName)
        service.httpClient.prepareGet(url).execute { httpResponse ->
            val channel: ByteReadChannel = httpResponse.body()
